...
EVENTHUB_CONNECTION_STR = os.environ['EVENT_HUB_CONNECTION_STRING']
...
# To create the producer through the default azure credentials and event hub namespace name
...
# To create the producer through eventhub connection string
